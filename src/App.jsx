  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 24, padding: "24px 0" }}>
      ...
      <div style={{ textAlign: "center", minHeight: 60 }}>
        ...
        <p key={idx} style={{ fontSize: 17, color: T.accent, fontWeight: 600, margin: 0, animation: "fadeMsg 0.4s ease" }}>{LOADING_STEPS[idx].msg}</p>
      </div>
        ...
        {step === "result" && result && (
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ textAlign: "center" }}>
              ...
              <h2 style={{ ...H, fontSize: 24, background: T.accentGrad, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>{userName}さんの診断結果</h2>
            </div>
            ...
            <div style={C}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                <span style={{ fontSize: 24 }}>🎨</span><h3 style={{ ...H, fontSize: 18 }}>色合わせ分析</h3>
              </div>
