...
{"tpo_comment":"「${impression}」を${who}に見せたい${scene}シーンでの服装適合度について2文。${colorNames}に具体的に言及","color_harmony":"${colorNames}の調和について1文。色名を使って具体的に","color_suggestion":"改善提案1文。具体的な色名やアイテム名を挙げて","strengths":["良い点3つ。各30字以内。色やスタイルに具体的に言及"],"risks":["辛口リスク3つ。各40字以内。相手からどう見えるかを率直に指摘。「〜と思われる」「〜に映る」等"]}`;
